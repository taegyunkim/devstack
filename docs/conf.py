...
"""
devstack documentation build configuration file.
...
# Note: Devstack is unversioned, so stating as-such for now.
VERSION = 'Unversioned'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'For developing on Open edX.',
     'Miscellaneous'),
]
